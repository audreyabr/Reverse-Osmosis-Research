...
def distance():
    '''
    Ultrasonic Sensor Code to calculate distances
...
#           check_salinity(conductivity_list) # won't work until conductivity sensor is connected
            ...
            if tank_is_empty == True:
                ...
                print("tank is empty")
                # while timer < 9 or tank_is_full == False:
...
#                         if brine_beat_the_feed == 0:
#                             GPIO.output(16,GPIO.HIGH) # relay is OFF, so valve is closed
#                             print("Brine valve is closed")
#                             GPIO.output(13,GPIO.HIGH) # relay is OFF, so valve is open
                        print("Break")
                        break 
#                     if tank_is_full == True and elapsed_time >= 9:
#                         print("hj")
#                         break
#                     
                    '''
                    It breaks when it is counting and the tank is empty or full? Either one of the limits.
                    Could be something to do with timing too within the distance() code. 
