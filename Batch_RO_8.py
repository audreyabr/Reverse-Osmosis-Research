...
def conductivity_reading():
    ...
    and converts it to a conductivity reading (mS)
    
    Returns:
        conductivity: an integer representing the conductivity in mS
    '''
    ...
    while True:
        ...
        if tank_is_empty == True:
            ...
            if tank_is_full == True:
                ...
                print("TANK IS FULL") # only feed valve turns off until we get conductivity sensor
                conductivity_reading()
