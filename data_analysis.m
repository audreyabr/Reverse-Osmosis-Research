% reading data
data = readtable('66_2021-10-02.csv'); % name of file being analyzed
...
flow_rate = A(:,4);  n % flow rate, mL/min
mass = A(:,5);         % mass, g
...
% calculates and plots salinity and flux
% parameters to enter each time
sal_pct_i = 3.5; % initial salinity (in %) for salinity-based estimation of recovery
P_psi = 350; % applied pressure in psig
