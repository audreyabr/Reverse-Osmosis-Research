...
% assigning variables
time = time_list(1:609,:);                              % time, seconds
conductivity = conductivity_list(:,1);                  % conductivity, mS/cm
distance = distance_list(1:609,:);                      % distance, cm
batch_flow_rate = flowrate_list(1:609,:);               % flow rate, mL/min
permeate_flow_rate = permeate_flowrate_list(1:609,:);   % flow rate, mL/min
mass = mass_list(1:609,:);                              % mass, g
