...
while run == 1
    ...
    [multip_voltage_readings, permeate_flowrate_list_D, current_permeate_flowrate_D, flowrate_list, current_flowrate, conductivity_list, conductivity] = daq_reading(dq, permeate_flowrate_list_D, flowrate_list, conductivity_list);
        ...
        volume_flushed = 0; % ml
            ...
            if volume_flushed < flush_tube_volume 
                ...
                while volume_flushed < flush_tube_volume
                    ...
                    [permeate_flowrate_list_a, current_permeate_flowrate_a] = permeate_flowrate_reading(a, permeate_flowrate_list, perm_flowrate_pin);
