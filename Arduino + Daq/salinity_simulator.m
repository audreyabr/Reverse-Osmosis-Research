function [dist_full,dist_empty,batch_vol,brine_vol,brine_concn,min_feed_pres,batch_conductivity,brine_conductivity,grams_CaCl_dihydrate,grams_Na2SO4] = salinity_simulator(feed_concn,batch_time,RR)
...
% based on intended feed concentration(mM), batch time(hour) and recovery
% rate(%)
