...
brine_vol = Water_Tank_Calculations(tank_height - empty_dis) + 100;
...
[grams_CaCl_dihydrate,grams_Na2SO4]= CaSO4_mixing(batch_salinity,batch_vol/1000);% convert batch volume to liter
