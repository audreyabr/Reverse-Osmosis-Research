function [time_list, permeate_flowrate_list, flowrate_list, conductivity_list, permeate_volume_list, tank_state_list, tank_volume_list] = main_data_collection(dq, time_list, tank_volume_list, permeate_flowrate_list, flowrate_list, conductivity_list, permeate_volume_list, tank_state_list, filename,t, empty_tank_volume, full_tank_volume)
...
%
% Outputs:
%   Seven data lists saved in the csv file, including time_list, 
%   conductivity_list, tank_volume_list, permeate_flowrate_list, batch flowrate_list, 
%   permeate_volume_list, tank_state_list
    ...
    [permeate_flowrate_list, permeate_flowrate, batch_flowrate_list, batch_flowrate, conductivity_list, conductivity, tank_volume_list] = daq_reading(dq, permeate_flowrate_list, flowrate_list, conductivity_list,tank_volume_list);
