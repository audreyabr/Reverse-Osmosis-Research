...
empty_tank_dist = 27,1925;  % cm, top of the tank to the top of the drainage square with some extra room
full_tank_dist = 21.47;  % cm  (CHANGE LATER?)
