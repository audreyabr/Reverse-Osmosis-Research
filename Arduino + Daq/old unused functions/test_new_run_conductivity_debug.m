...
while run == 1
    ...
    if(conductivity_list(end) < end_conductivity)&&(tank_state ~= 0)
        ...
        batch_open = 1;
        debug_matrix = add_debug_row(debug_matrix, feed_open, batch_open, brine_open);
...
% append debug matrix
function debug_matrix = add_debug_row(debug_matrix, feed_open, batch_open, brine_open)   
